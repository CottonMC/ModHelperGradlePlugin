...
class FabricModJson {
    ...
    private var mixins: Array<String> = emptyArray()
        get() = mixins.copyOf()

    var depends: Map<String, String> = emptyMap()


    fun addMixin(mixin: String, side: Side): Boolean {
...
class FabricEntrypointContainer @JvmOverloads constructor(val map: Map<String, List<FabricModEntrypoint>> = emptyMap()) {
    internal object JsonAdapter : JsonSerializer<FabricEntrypointContainer>,
        JsonDeserializer<FabricEntrypointContainer> {
